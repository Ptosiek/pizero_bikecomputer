...
def main():
    ...
    with timers[0]:
        from pizero_bikecomputer.modules.config import Config
    ...
    # display
    with timers[2]:
        from pizero_bikecomputer.modules.display.display_core import init_display
    ...
    with timers[5]:
        from pizero_bikecomputer.modules import logger_core
