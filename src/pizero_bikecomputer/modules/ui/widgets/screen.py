...
from pizero_bikecomputer.modules._pyqt import QT_EXPANDING, QtCore, QtWidgets, qasync
from pizero_bikecomputer.modules.constants import (
    ANTDevice,  # noqa (needed for AntWidget)
)
