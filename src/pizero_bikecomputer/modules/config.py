...
from pizero_bikecomputer.modules.button_config import Button_Config
from pizero_bikecomputer.modules.settings import settings
from pizero_bikecomputer.modules.state import AppState
from pizero_bikecomputer.modules.utils.cmd import (
    exec_cmd,
...
class Config:
    ...
    async def delay_init(self):
        ...
        from pizero_bikecomputer.modules.helper.api import Api
        from pizero_bikecomputer.modules.helper.network import Network
        ...
        try:
            from pizero_bikecomputer.modules.helper.bt_pan import BTPan  # noqa
        ...
        if self.bt_pan and settings.BT_TETHERING_DEVICE and settings.BT_AUTO_TETHERING:
        ...
        if settings.IS_RASPI:
            try:
                from pizero_bikecomputer.modules.helper.ble_gatt_server import (
                    GadgetbridgeService,
                )
