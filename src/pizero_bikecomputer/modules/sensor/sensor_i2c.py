...
from pizero_bikecomputer.modules.constants import ANTDevice
from pizero_bikecomputer.modules.settings import settings
from pizero_bikecomputer.modules.utils.filters import KalmanFilter, KalmanFilter_pitch
from pizero_bikecomputer.modules.utils.geo import get_track_str
...
class SensorI2C(Sensor):
    ...
    def detect_sensors(self):
        ...
        if not self.available_sensors["PRESSURE"]["LPS3XHW"]:
            self.available_sensors["PRESSURE"]["LPS3XHW_ORIG"] = (
        ...
        if not self.available_sensors["PRESSURE"]["BMP280"]:
            self.available_sensors["PRESSURE"]["BMP280_ORIG"] = (
        ...
        self.available_sensors["MOTION"]["LSM303_ORIG"] = (
        ...
        # button
        self.available_sensors["BUTTON"]["BUTTON_SHIM"] = (
