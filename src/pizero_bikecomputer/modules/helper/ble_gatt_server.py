...
from pizero_bikecomputer.modules.sensor.gps.base import (
    HDOP_CUTOFF_FAIR,
...
from pizero_bikecomputer.modules.utils.asyncio import call_with_delay
from pizero_bikecomputer.modules.utils.time import set_time
