...
from pizero_bikecomputer.modules.loaders import TcxLoader
from pizero_bikecomputer.modules.settings import settings
from pizero_bikecomputer.modules.utils.filters import savitzky_golay
...
class Course:
    ...
    def __str__(self):
        return f"Course:\n{oyaml.dump(self.info, allow_unicode=True)}\n"
