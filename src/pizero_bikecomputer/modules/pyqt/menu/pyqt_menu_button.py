...
from pizero_bikecomputer.modules.pyqt.components import icons
...
class MenuButton(QtWidgets.QPushButton):
    ...
    res_img = {
        True: QtGui.QIcon(str(BASE_DIR / "cloud_upload_done.svg")),
        False: QtGui.QIcon(str(BASE_DIR / "button_warning.svg")),
    }
